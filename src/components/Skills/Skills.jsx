...
const Skills = () => (
  ...
  >
    ...
    {/* Categories */}
    <div className="flex flex-wrap gap-4 py-10 justify-between">
      {SkillsInfo.map((category) => (
        <div
          key={category.title}
          className="bg-gray-900 px-6 sm:px-10 py-8 w-full sm:w-[48%] rounded-2xl border border-white shadow-[0_0_20px_rgba(130,69,236,0.3)]"
        >
