    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Kaif</span>
          <span className="text-[#8245ec]">/</span>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="absolute top-16 left-1/2 -translate-x-1/2 w-4/5 bg-[#050414]/50 backdrop-blur-lg rounded-lg shadow-lg md:hidden">
          <ul className="flex flex-col items-center gap-4 py-4 text-gray-300">
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://github.com/Kaifkhan-Code" target="_blank">
                <FaGithub size={24} />
              </a>
              <a href="https://www.linkedin.com/in/md-kaif-alam-khan-7374a1321" target="_blank">
                <FaLinkedin size={24} />
              </a>
            </div>
          </ul>
